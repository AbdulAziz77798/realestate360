                ...
                <div className="flexColStart left">
                    ...
                    <div className="flexStart facilities">
                        ...
                        <div className="flexStart facility">
                            ...
                            <span style={{fontSize:14}}>{data?.facilities?.bathrooms} Bathrooms</span>
                        </div>

                        <div className="flexStart facility">
                            <AiTwotoneCar size={20} color='#1F3E72'/>
                            <span style={{fontSize:14}}>{data?.facilities.parkings} Parking</span>
                        </div>

                        <div className="flexStart facility">
                            <MdMeetingRoom size={20} color="#1F3E72"/>
                            <span style={{fontSize:14}}>{data?.facilities.bedrooms} Rooms</span>
                        </div>
...

                    {
                        ...
                        (
                            <button className="button" onClick={()=> {validateLogin() && setModelOpened(true) }}>
                                Book your visit
                            </button>
                        )
                    }
